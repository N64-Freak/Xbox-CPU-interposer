...
For the upgrade you should have good tools to suceed. Especially good soldering equipment and a steady hand!
You will need:
...
But because they get more expensive, I recommend to use a 1000Mhz or 1200Mhz CPU to practice and move on to the more expensive CPU once you succeeded.
...
NOTE: If you have a Rev1.2-1.4 you need to buy an extra 1.5KOhm 0603 resistor to set the CPU core voltage!
...
First thing to do is reball the CPU adapter. You need the 0.76mm leaded solder balls, flux and the reball stencil.
...
---Don't forget about this step or your CPU might get damaged on the first startup!---
Only a few changes have to be made to the resistors on the Xbox console. Choose the correct image for the revision of your console.
...
You can install all of them at once or just the parts that will be below the CPU once installed.
That's up to you!
